...
# --- Page 2: liver Cancer Death Rate Summary---
...
# Filter liver_df for year 2005
liver_df_2005 = liver_df[liver_df["year"] == 2005]

# Select top 10 countries with highest male liver cancer deaths in 2005
top10_men_selected = liver_df_2005.nlargest(10, "male_death_rate")
...
fig_bar = px.bar(
    ...
    x="male_death_rate",
    y="country",
    title="Top 10 Countries with Highest Liver Cancer Deaths in Men (2005)",
...
# 3. Value box: Global average, peak, and minimum value for 2005
...
# Select top 10 countries with highest female liver cancer deaths in 2005
top10_women_selected = liver_df_2005.nlargest(10, "female_death_rate")
...
fig_bar_women = px.bar(
    ...
    title="Top 10 Countries with Highest Liver Cancer Deaths in Women (2005)",
    labels={"female_death_rate": "Deaths per 100,000 Women", "country": "Country"},
)
fig_bar_women.update_layout(
    yaxis={"categoryorder": "total ascending"}, coloraxis_showscale=False
)
...
The global average in 2005 is {global_avg_female:.2f}, with {global_max_female_country} experiencing the highest rate at {global_max_female:.2f} deaths per 100,000 women.
"""
...
## ---Page 3: Global Smoking Prevalence Summary---
...
## Page 4---Relationship between Liver Cancer Death Rate and Smoking---
...
## ---Page 5: Chloropleth Map for Liver Cancer Death and Smoking Rate---

# Find global maximum death rate (considering both male and female)
max_death_rate = liver_df_2005[['male_death_rate', 'female_death_rate']].max().max()

# Create choropleth map for male liver cancer death
fig_map_male_cancer = px.choropleth(
    liver_df_2005,
    locations="country_code",
    color="male_death_rate",
    hover_name="country",
    animation_frame="year",
    title="Global Male Liver Cancer Death (2005)",
    color_continuous_scale="Cividis",
    range_color=[0, max_death_rate]
)

# Create choropleth map for female liver cancer death
fig_map_female_cancer = px.choropleth(
    liver_df_2005,
    locations="country_code",
    color="female_death_rate",
    hover_name="country",
    animation_frame="year",
    title="Global Female Liver Cancer Death (2005",
    color_continuous_scale="Cividis",
    range_color=[0, max_death_rate]
)


# Find global maximum smoking rate (considering both male and female)
max_smoking_rate = smokers_df_2005[['male_smokers(%)', 'female_smokers(%)']].max().max()
...
fig_map_male_smoker = px.choropleth(
    ...
    range_color=[0, max_smoking_rate]
)
...
### Liver Cancer Global Male Map

```{python}
fig_map_male_cancer
```

### Liver Cancer Global Female Map

```{python}
fig_map_female_cancer
```

## Row 2{height="50%"}

### Smoking Rate Global Male Map

```{python}
fig_map_male_smoker
```

### Smoking Rate Global Female Map
